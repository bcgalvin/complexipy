...
records the narrower adoption and chosen document homes. The tracker remains
the execution plan; `CHANGELOG.md` is not regenerated by this report.
...
in the tracker. Earlier validation of the discarded machinery is not evidence
