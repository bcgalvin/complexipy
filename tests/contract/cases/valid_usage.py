...
category_name: str = RuleCategory.Complexity.name
category_value: str = RuleCategory.Complexity.value
statuses: list[DiffStatus] = list(DiffStatus)
looked_up: Applicability = Applicability("MaybeIncorrect")
indexed: DiffStatus = DiffStatus["REMOVED"]
