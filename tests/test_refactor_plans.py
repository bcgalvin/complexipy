...
def test_collapsible_if_skips_preceding_sibling_after_trailing_comment() -> (
    None
):
    func = first_func(
...
def test_inline_rule_list_suppresses_only_named_rules():
...
def test_bare_ignore_comment_drops_the_function():
