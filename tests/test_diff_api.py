...
def test_the_round_trip_compares_against_a_git_ref(repo):
    commit(repo, NESTED)
...
def test_the_objects_passed_back_carry_enum_fields(repo):
    commit(repo, NESTED)
...
def test_a_ratchet_failure_is_reported(repo):
    commit(repo, PLAIN)
